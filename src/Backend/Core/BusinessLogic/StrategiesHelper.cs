...
namespace Core.BusinessLogic
{
	public static class StrategiesHelper
	{
		...
		{
			[nameof(AdxMasStrategy)] = options => new AdxMasStrategy((AdxMasStrategyOptions)options),
			[nameof(AwesomeMacdStrategy)] = options => new AwesomeMacdStrategy((AwesomeMacdStrategyOptions)options),
			[nameof(AwesomeMaStrategy)] = options => new AwesomeMaStrategy((AwesomeMaStrategyOptions)options),
			...
			[nameof(CciMaStrategy)] = options => new CciMaStrategy((CciMaStrategyOptions)options),
			...
			[nameof(MaAdxMacdStrategy)] = options => new MaAdxMacdStrategy((MaAdxMacdOptions)options),
			[nameof(MaCrossStrategy)] = options => new MaCrossStrategy((MaCrossStrategyOptions)options),
			...
			[nameof(MacdMaStrategy)] = options => new MacdMaStrategy((MacdMaStrategyOptions)options),
			...
			[nameof(RsiSmaCrossoverStrategy)] = options => new RsiSmaCrossoverStrategy((RsiMaCrossoverStrategyOptions)options),
			...
			[nameof(MaStochRsiStrategy)] = options => new MaStochRsiStrategy((MaStochRsiStrategyOptions)options),
